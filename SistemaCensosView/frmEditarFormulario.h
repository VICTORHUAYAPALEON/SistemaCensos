...
namespace SistemaCensosView {
	...
	/// <summary>
	/// Resumen de frmEditarFormulario
	/// </summary>
	public ref class frmEditarFormulario : public System::Windows::Forms::Form
	{
	public:
		frmEditarFormulario(void)
		{
			InitializeComponent();
			//
		...
		frmEditarFormulario(GestorFormulario^ objGestorFormulario,int codigoFormularioEditar) {
			InitializeComponent();
			this->objGestorFormulario = objGestorFormulario;
			this->codigoFormularioEditar = codigoFormularioEditar;
			this->objGestorPreguntaSalvar = gcnew GestorPregunta();
	...
	private: int codigoFormularioEditar;
	private: GestorPregunta^ objGestorPreguntaSalvar;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarFormulario::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmEditarFormulario::button1_Click);
			// 
			// textBox4
			// 
			...
			this->ClientSize = System::Drawing::Size(438, 461);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmEditarFormulario";
			this->Text = L"frmEditarFormulario";
			this->Load += gcnew System::EventHandler(this, &frmEditarFormulario::frmEditarFormulario_Load);
...
#pragma endregion
	private: System::Void frmEditarFormulario_Load(System::Object^ sender, System::EventArgs^ e) {
		Formulario^ objFormularioEditar = this->objGestorFormulario->ObtenerFormularioxCodigo(this->codigoFormularioEditar);

		this->textBox1->Text = Convert::ToString(objFormularioEditar->codigoFormulario);
		this->textBox1->ReadOnly = "True";
		this->textBox2->Text = objFormularioEditar->Titulo;
		this->textBox3->Text = objFormularioEditar->Seccion;
		this->textBox4->Text = Convert::ToString(objFormularioEditar->NroSecciones);
		this->textBox5->Text = objFormularioEditar->PersonaResponsable;
	}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	Formulario^ objFormularioEditar = gcnew Formulario(codigoFormulario, Titulo, Seccion, NroSecciones, PersonaResponsable);
	this->objGestorFormulario->EliminarFormularioxCodigoSalvaPreguntas(codigoFormulario,this->objGestorPreguntaSalvar);
	this->objGestorFormulario->DevolverListaPreguntasFormulario(objFormularioEditar,this->objGestorPreguntaSalvar);
	this->objGestorFormulario->AgregarFormularioLista(objFormularioEditar);
	MessageBox::Show("Formulario Editado");
	this->Close();
}

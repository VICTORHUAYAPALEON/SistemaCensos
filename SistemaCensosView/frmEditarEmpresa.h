...
namespace SistemaCensosView {
	...
	public:
		...
		frmEditarEmpresa(GestorEmpresa^ objGestorEmpresa,int codigoEditar)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(210, 306);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(76, 306);
			...
			this->groupBox1->Location = System::Drawing::Point(22, 19);
			...
			this->ClientSize = System::Drawing::Size(384, 348);
...
#pragma endregion
	private: System::Void FrmEditarEmpresa_Load(System::Object^ sender, System::EventArgs^ e) {
		Empresa^ objEmpresaEditar = this->objGestorEmpresa->ObtenerEmpresaxcodigo(codigoEditar);
		this->textBox1->Text= Convert::ToString(objEmpresaEditar->codigo);
		this->textBox2->Text = objEmpresaEditar->RazonSocial;
		this->textBox3->Text = objEmpresaEditar->URL;
		this->textBox4->Text = objEmpresaEditar->RUC;
		this->textBox5->Text = objEmpresaEditar->Direccion;
		this->textBox6->Text = objEmpresaEditar->AreaLaboral;
	}
private: System::Void Button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	this->objGestorEmpresa->EliminarEmpresa(codigo);

...
namespace SistemaCensosView {
	...
	public:
		...
		frmNuevoUsuario(GestorUsuario^ objGestorUsuario)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(218, 313);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(84, 313);
			...
			this->ClientSize = System::Drawing::Size(402, 375);

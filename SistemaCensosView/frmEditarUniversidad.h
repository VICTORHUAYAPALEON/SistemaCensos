...
namespace SistemaCensosView {
	...
	/// <summary>
	/// Resumen de frmEditarUniversidad
	/// </summary>
	public ref class frmEditarUniversidad : public System::Windows::Forms::Form
	{
	public:
		frmEditarUniversidad(void)
		{
			InitializeComponent();
			//
		...
		frmEditarUniversidad(GestorEntidadUniversidad^ objGestorUniversidad, String^ nombreEditar) {
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(253, 288);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 18;
			this->button2->Text = L"Cancelar";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarUniversidad::button2_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(110, 288);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 17;
			this->button1->Text = L"Grabar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &frmEditarUniversidad::button1_Click);
			// 
			// label1
			// 
			...
			this->groupBox1->Location = System::Drawing::Point(32, 22);
			...
			this->ClientSize = System::Drawing::Size(462, 326);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->groupBox1);
			this->Controls->Add(this->button1);
			this->Name = L"frmEditarUniversidad";
			this->Text = L"frmEditarUniversidad";
			this->Load += gcnew System::EventHandler(this, &frmEditarUniversidad::CargarVentana);
...
#pragma endregion
	private: System::Void CargarVentana(System::Object^ sender, System::EventArgs^ e) {
		EntidadUniversidad^ objUniversidadEditar = this->objGestorUniversidad->ObtenerUniversidadxNombre(this->nombreEditar);
		this->textBox1->Text = objUniversidadEditar->nombre;
		this->textBox2->Text = objUniversidadEditar->direccion;
		this->textBox3->Text = objUniversidadEditar->telefono;
		this->comboBox1->Text = objUniversidadEditar->tipoGestion;
		this->textBox4->Text = objUniversidadEditar->paginaWeb;
		this->comboBox2->Text = objUniversidadEditar->licenciaSunedu;	
	}
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	String^ licenciaSunedu = this->comboBox2->Text;
	...
	this->objGestorUniversidad->EliminarUniversidad(nombre);
	this->objGestorUniversidad->AgregarUniversidadALista(objUniversidad);
	MessageBox::Show("Universidad editada correctamente");
	this->Close();
}
};
}

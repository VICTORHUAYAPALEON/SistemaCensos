...
namespace SistemaCensosView {
	...
	/// <summary>
	/// Resumen de frmEditarColegio
	/// </summary>
	public ref class frmEditarColegio : public System::Windows::Forms::Form
	{
	public:
		frmEditarColegio(void)
		{
			InitializeComponent();
			//
		...
		frmEditarColegio(GestorEntidadColegio^ objGestorColegio, String^ nombreEditar) {
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(247, 328);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 15;
			this->button2->Text = L"Cancelar";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarColegio::button2_Click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Location = System::Drawing::Point(24, 12);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(397, 310);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(120, 328);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 14;
			this->button1->Text = L"Grabar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &frmEditarColegio::button1_Click);
			// 
			// frmEditarColegio
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(448, 360);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->groupBox1);
			this->Controls->Add(this->button1);
			this->Name = L"frmEditarColegio";
			this->Text = L"frmEditarColegio";
			this->Load += gcnew System::EventHandler(this, &frmEditarColegio::CargarVentana);
...
#pragma endregion
	...
	private: System::Void CargarVentana(System::Object^ sender, System::EventArgs^ e) {
		EntidadColegio^ objColegioEditar = this->objGestorColegio->ObtenerColegioxNombre(this->nombreEditar);
		this->textBox1->Text = objColegioEditar->nombre;
		this->textBox2->Text = objColegioEditar->direccion;
		this->textBox3->Text = objColegioEditar->telefono;
		this->textBox4->Text = objColegioEditar->nombreUgel;
		this->textBox5->Text = objColegioEditar->codigoModular;
		this->comboBox1->Text = objColegioEditar->nivelEducativo;
		this->comboBox2->Text = objColegioEditar->tipoGestion;
		this->comboBox3->Text = objColegioEditar->Turno;
	}
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->objGestorColegio->EliminarColegio(nombre);
		this->objGestorColegio->AgregarColegioLista(objColegio);
		MessageBox::Show("Colegio editado correctamente");
		this->Close();
	}
	};
};
